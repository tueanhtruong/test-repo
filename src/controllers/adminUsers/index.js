...
var AdminUsersController = /** @class */ (function () {
                        ...
                        return [2 /*return*/, {
                                data: data.map(function (n) {
                                    ...
                                    return ({
                                        ...
                                        email: n.email,
                                        role: n.role.name,
                                        createdDate: (_a = n.createdDate) === null || _a === void 0 ? void 0 : _a.toISOString(),
                                    });
                                }),
                                total: total,
                            }];
    ...
    AdminUsersController.prototype.updateUserRole = function (request) {
        var _a, _b;
        return __awaiter(this, void 0, void 0, function () {
            var accountService, id, roleId, user;
            return __generator(this, function (_c) {
                switch (_c.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, accountService.updateUserRole({ id: id, roleId: roleId })];
                    case 1:
                        user = _c.sent();
                        return [2 /*return*/, user];
                }
