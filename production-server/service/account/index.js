    ...
    AccountsService.prototype.updateUserRole = function (payload) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        if (!(typeof (payload === null || payload === void 0 ? void 0 : payload.isDisabled) === "boolean")) return [3 /*break*/, 4];
                        _a.label = 1;
                    case 1:
                        _a.trys.push([1, 3, , 4]);
                        return [4 /*yield*/, firebase_config_1.admin
                                .auth()
                                .updateUser(payload.uid, { disabled: payload === null || payload === void 0 ? void 0 : payload.isDisabled })];
                    case 2:
                        _a.sent();
                        return [3 /*break*/, 4];
                    case 3:
                        err_1 = _a.sent();
                        throw err_1;
                    case 4: return [4 /*yield*/, repositories_1.accountRepo.updateAccountRole(payload)];
                    case 5:
                        account = _a.sent();
                        if (!account) {
                            throw new utils_1.NotFoundError("Can not found your user account");
