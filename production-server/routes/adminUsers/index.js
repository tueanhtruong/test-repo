...
router.get("/", function (req, res, next) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                controller = new controllers_1.AdminUsersController();
                return [4 /*yield*/, controller.getUsers(req)];
            case 1:
                response = _a.sent();
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                controller = new controllers_1.AdminUsersController();
                return [4 /*yield*/, controller.getUserById(req)];
            case 1:
                response = _a.sent();
                return [2 /*return*/, res.status(http_status_1.default.OK).send(response)];
            case 2:
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                controller = new controllers_1.AdminUsersController();
                return [4 /*yield*/, controller.updateUserRole(req)];
            case 1:
                response = _a.sent();
                return [2 /*return*/, res.status(http_status_1.default.OK).send(response)];
            case 2:
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                controller = new controllers_1.AdminUsersController();
                return [4 /*yield*/, controller.CreateNewUser(req)];
            case 1:
                response = _a.sent();
                return [2 /*return*/, res.status(http_status_1.default.OK).send(response)];
            case 2:
