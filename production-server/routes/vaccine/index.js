...
router.post("/", function (req, res, next) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                controller = new controllers_1.VaccineController();
                return [4 /*yield*/, controller.createVaccineRegistry(req.body)];
            case 1:
                response = _a.sent();
...
router.get("/", function (req, res, next) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        ...
        try {
            ...
            return [2 /*return*/, res.status(http_status_1.default.OK).send({ message: a })];
        }
        catch (err) {
            next(err);
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                controller = new controllers_1.VaccineController();
                return [4 /*yield*/, controller.updateVaccineRegistry(req.body)];
            case 1:
                response = _a.sent();
                return [2 /*return*/, res.status(http_status_1.default.OK).send(response)];
            case 2:
